...
let wasmBinding: BigIntBuffer2 | null = null;
let wasmLoading: Promise<BigIntBuffer2> | null = null;
 ...
 */
async function loadWasm(): Promise<BigIntBuffer2> {
  try {
 ...
 *
 * @returns Promise resolving to BigIntBuffer2 implementation
 */
export async function getWasm(): Promise<BigIntBuffer2> {
  if (wasmBinding !== null) {
    return wasmBinding;
  }
 ...
 *
 * @returns BigIntBuffer2 implementation (WASM if loaded, fallback otherwise)
 */
export function getWasmSync(): BigIntBuffer2 {
